...
KellyTools.setCopyright = function(id, context) {
    ...
    if (context == 'popup') html = '<a target="_blank" href="/env/html/recorderDownloader.html?tab=help">' + KellyLoc.s('', 'help') + '</a>© <a target="_blank" href="https://github.com/Remilya/DeksmoScrap">' + KellyLoc.s('', 'nradiowave_person') + '</a>';
